...
export const cards: Card[] = [
  ...
  { id: "shield-bash", name: "Shield Bash", kind: "skill", value: 2, range: 1 },
  { id: "arc-bolt", name: "Arc Bolt", kind: "spell", value: 3, range: 3 },
  { id: "lunge", name: "Lunge", kind: "skill", value: 3, range: 2 },
  { id: "parry", name: "Parry", kind: "skill", value: 0, range: 0 }
];
